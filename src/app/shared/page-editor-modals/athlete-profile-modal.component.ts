            ...
            <div class="flex items-center gap-4">
              <div class="relative group shrink-0">
                @if (avatarUrl()) {
                  ...
                  <div class="h-20 w-20 rounded-full bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-white/50 grid place-items-center border border-gray-200 dark:border-white/10">
