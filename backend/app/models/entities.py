...
# ----------------------------------------------------------------------
# Lookups & Catálogos Dinámicos
# ----------------------------------------------------------------------
class LookupGroup(Base):
    __tablename__ = "lookup_groups"

    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    code: Mapped[int] = mapped_column(BigInteger, unique=True, nullable=False)
...
class LookupItem(Base):
    ...
    code: Mapped[int] = mapped_column(BigInteger, nullable=False, index=True)
...
class AppVersion(Base):
    ...
    version_code: Mapped[int] = mapped_column(BigInteger, nullable=False)
    min_supported_version_code: Mapped[int] = mapped_column(BigInteger, nullable=False)
...
class AthleteProfile(Base):
    ...
    primary_sport_code: Mapped[int | None] = mapped_column(BigInteger, nullable=True, index=True)
...
# ----------------------------------------------------------------------
# Metas, Membresías, Tienda, Asesorías & Transacciones
# ----------------------------------------------------------------------
class Goal(Base):
    __tablename__ = "goals"
...
class BookingService(Base):
    ...
    title: Mapped[str] = mapped_column(String(200), nullable=False)
    description: Mapped[str | None] = mapped_column(Text, nullable=True)
    duration_minutes: Mapped[int] = mapped_column(BigInteger, default=45)
    price: Mapped[Decimal] = mapped_column(Numeric(8, 2), nullable=False)
...
class Transaction(Base):
    ...
    transaction_type_code: Mapped[int] = mapped_column(BigInteger, default=201, index=True)
    shakes_count: Mapped[int] = mapped_column(BigInteger, default=1)
    ...
    status_code: Mapped[int] = mapped_column(BigInteger, default=301, index=True)
