...
class AthleteProfile(Base):
    ...
    currency: Mapped[str] = mapped_column(Enum("USD", name="currency_enum"), default="USD")
...
class Goal(Base):
    ...
    currency: Mapped[str] = mapped_column(Enum("USD", name="goal_currency_enum"), default="USD")
    is_active: Mapped[bool] = mapped_column(Boolean, default=True)
...
class MembershipTier(Base):
    ...
    currency: Mapped[str] = mapped_column(Enum("USD", name="tier_currency_enum"), default="USD")
...
class DigitalProduct(Base):
    ...
    currency: Mapped[str] = mapped_column(Enum("USD", name="product_currency_enum"), default="USD")
...
class BookingService(Base):
    ...
    price: Mapped[Decimal] = mapped_column(Numeric(8, 2), nullable=False)
    currency: Mapped[str] = mapped_column(Enum("USD", name="booking_currency_enum"), default="USD")
...
class Transaction(Base):
    ...
    currency: Mapped[str] = mapped_column(Enum("USD", name="trans_currency_enum"), default="USD")
